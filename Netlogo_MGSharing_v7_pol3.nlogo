...
energy-provider-own [energy  agentset-consumer profit-microgrid]
...
to upgrade-income
  set profit-consumer-high 10
  set profit-consumer-low 4
...
to replace-components
  ...
  if ticks mod 10 = 0 [
    ask energy-provider [
      if count agentset-consumer > 2 [
        set profit-microgrid (profit-microgrid - replacement-cost-microgrid)
        set microgrid-profit profit-microgrid  ]]]
end
@#$#@#$#@
GRAPHICS-WINDOW
