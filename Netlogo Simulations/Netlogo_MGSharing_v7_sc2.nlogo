globals [energy-variation ratio low-ratio mid-ratio per-shops per-bf per-sf profit-battery investment-month maximum-batteries-sold producers non-producers consumers non-consumers]
...
to sell-energy
  ...
  ask producers[
      ...
      ask agentset-consumer [
        set energy-variation random 8
        set role "consumer"
        set pcolor black
        set color green
        set energy (energy + (energy-variation * demand-rise))
        ifelse energy < 3 [
          set size (energy + 1)][
          set size 3]
      ...
      if ticks mod 12 = 0 [
        if agentset-consumer != 0 [
          ask min-n-of (0.5 * count agentset-consumer) agentset-consumer [who] [
            set energy (energy - (energy-variation * demand-rise))
            ask my-producer [set energy (energy + (energy-variation * demand-rise))]]]]
